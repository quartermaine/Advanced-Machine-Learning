## ----global_options, R.options=knitr::opts_chunk$set(warning=FALSE, message=FALSE,echo=F,knitr.table.format = "latex")----
...
## ----code = readLines(knitr::purl("~/Courses/Advanced ML/Labs/Lab4/LAB4_AML.Rmd",documentation = 1)), echo = T, eval = F----
## NA
